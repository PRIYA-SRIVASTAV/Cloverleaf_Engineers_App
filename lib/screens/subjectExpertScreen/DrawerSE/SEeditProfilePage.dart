...
class SEeditProfilePage extends StatefulWidget {
  const SEeditProfilePage({super.key});

  @override
  State<SEeditProfilePage> createState() => _SEeditProfilePageState();
}

class _SEeditProfilePageState extends State<SEeditProfilePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        ...
        child: is_load_SE_profile_details_data
            ? Padding(
