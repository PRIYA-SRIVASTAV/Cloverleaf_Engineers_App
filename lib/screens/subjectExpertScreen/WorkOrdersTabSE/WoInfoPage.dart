...
class woInfoPage extends StatefulWidget {
  var Tab1Index;

  woInfoPage({required this.Tab1Index, super.key});

  @override
  State<woInfoPage> createState() => _woInfoPageState();
}
...
class _woInfoPageState extends State<woInfoPage> {
  ...
  void get_SE_work_order_status2_method() async {
    ...
    //inviteeController.text = get_SE_work_order_status2.data![widget.Tab1Index].zegoUserId!;
