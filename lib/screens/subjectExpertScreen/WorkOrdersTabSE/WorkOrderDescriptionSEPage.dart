...
class WorkOrderDescriptionSEpage extends StatefulWidget {
  ...
  @override
  State<WorkOrderDescriptionSEpage> createState() => _WorkOrderDescriptionSEpageState();
}

class _WorkOrderDescriptionSEpageState extends State<WorkOrderDescriptionSEpage> {
                              ...
                              child: ElevatedButton(
                                ...
                                onPressed: () {
                                  showDialog(
                                    context: context,
                                    builder: (context) {
                                      return Add_Parts_popup(context);
                                    },
                                  );
                                },
                                child: Icon(
