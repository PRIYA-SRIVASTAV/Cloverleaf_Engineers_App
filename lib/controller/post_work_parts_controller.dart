...
class post_work_parts_controller{
 ...
 Future post_SE_work_parts_controller_method(work_id,parts_id,parts_name,context)async{
   var r = await ApiCalling().post_SE_work_parts(work_id, parts_id, parts_name);
   if (r['status'].toString()=="true") {
     Navigator.pop(context);
     customFlutterToast(r["message"].toString());
   } else {
